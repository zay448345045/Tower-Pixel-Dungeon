...
package com.fixakathefix.towerpixeldungeon.actors.hero.abilities.rogue;
...
import com.fixakathefix.towerpixeldungeon.levels.CityLevel;
...
public class ShadowClone extends ArmorAbility {
	...
	public static class ShadowSprite extends MobSprite {
		...
		public ShadowSprite() {
			...
			if (Dungeon.hero != null )texture( Dungeon.hero.heroClass.spritesheet() );
			else texture(HeroClass.ROGUE.spritesheet());
