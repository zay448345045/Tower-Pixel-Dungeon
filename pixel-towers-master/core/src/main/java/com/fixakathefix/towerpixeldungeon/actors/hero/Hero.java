...
import com.fixakathefix.towerpixeldungeon.Bones;
...
import com.fixakathefix.towerpixeldungeon.actors.buffs.PhysicalEmpower;
import com.fixakathefix.towerpixeldungeon.actors.buffs.Recharging;
import com.fixakathefix.towerpixeldungeon.actors.buffs.Regeneration;
...
import com.fixakathefix.towerpixeldungeon.items.Heap.Type;
...
import com.fixakathefix.towerpixeldungeon.items.keys.Key;
...
import com.fixakathefix.towerpixeldungeon.items.weapon.melee.Flail;
...
import com.fixakathefix.towerpixeldungeon.items.weapon.melee.Sai;
...
import com.fixakathefix.towerpixeldungeon.scenes.SurfaceScene;
...
public class Hero extends Char {
	...
	public float critMult() {
		float totalmult = 0;
		if (hero.belongings.weapon != null) totalmult = hero.belongings.weapon.critMult * hero.critMult + RingOfLethality.critMultAdd(this);
		else totalmult = hero.critMult + RingOfLethality.critMultAdd(this);
		return totalmult;
	}
	@Override
	...
	public void updateHT( boolean boostHP ){
		...
		HT = (50 + 15*(lvl-1)) + HTBoost - (int)HTdrained;
	...
	public void checkVisibleMobs() {
		...
		for (Mob m : Dungeon.level.mobs.toArray(new Mob[0])) {
			if (fieldOfView[ m.pos ] && m.alignment == Alignment.ENEMY && !(m instanceof BossImage)) {
				visible.add(m);
