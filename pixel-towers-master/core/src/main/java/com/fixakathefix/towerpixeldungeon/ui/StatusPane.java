...
import com.fixakathefix.towerpixeldungeon.effects.CircleArc;
...
public class StatusPane extends Component {
	...
	public StatusPane( boolean large ){
		...
		//timeeCircleArc = new CircleArc(18, 5f);
	...
	public void update() {
		...
		if (Dungeon.hero.lvl != lastLvl) {
			...
			if (large){
				level.scale.set(0.75f);
				level.text( "L. " + lastLvl+", S." + Dungeon.hero.STR() );
				level.measure();
