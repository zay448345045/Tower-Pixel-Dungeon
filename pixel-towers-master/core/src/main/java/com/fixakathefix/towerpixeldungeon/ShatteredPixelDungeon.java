...
public class ShatteredPixelDungeon extends Game {
	...
	public ShatteredPixelDungeon( PlatformSupport platform ) {
		...
		com.watabou.utils.Bundle.addAlias(
				com.fixakathefix.towerpixeldungeon.actors.buffs.Bleeding.class,
				"com.fixakathefix.towerpixeldungeon.levels.features.Chasm$FallBleed" );
		com.watabou.utils.Bundle.addAlias(
				com.fixakathefix.towerpixeldungeon.plants.Mageroyal.class,
				"com.fixakathefix.towerpixeldungeon.plants.Dreamfoil" );
		com.watabou.utils.Bundle.addAlias(
				com.fixakathefix.towerpixeldungeon.plants.Mageroyal.Seed.class,
				"com.fixakathefix.towerpixeldungeon.plants.Dreamfoil$Seed" );

		com.watabou.utils.Bundle.addAlias(
				com.fixakathefix.towerpixeldungeon.items.weapon.curses.Dazzling.class,
				"com.fixakathefix.towerpixeldungeon.items.weapon.curses.Exhausting" );
		com.watabou.utils.Bundle.addAlias(
				com.fixakathefix.towerpixeldungeon.items.weapon.curses.Explosive.class,
				"com.fixakathefix.towerpixeldungeon.items.weapon.curses.Fragile" );
	}
