...
import com.fixakathefix.towerpixeldungeon.sprites.DrillSprite;
...
import com.fixakathefix.towerpixeldungeon.tiles.DungeonTerrainTilemap;
import com.fixakathefix.towerpixeldungeon.tiles.DungeonTileSheet;
import com.fixakathefix.towerpixeldungeon.tiles.DungeonTilemap;
import com.fixakathefix.towerpixeldungeon.tiles.DungeonWallsTilemap;
import com.fixakathefix.towerpixeldungeon.tiles.FogOfWar;
import com.fixakathefix.towerpixeldungeon.tiles.GridTileMap;
import com.fixakathefix.towerpixeldungeon.tiles.RaisedTerrainTilemap;
import com.fixakathefix.towerpixeldungeon.tiles.TerrainFeaturesTilemap;
import com.fixakathefix.towerpixeldungeon.tiles.WallBlockingTilemap;
import com.fixakathefix.towerpixeldungeon.ui.ActionIndicator;
import com.fixakathefix.towerpixeldungeon.ui.AttackIndicator;
import com.fixakathefix.towerpixeldungeon.ui.Banner;
import com.fixakathefix.towerpixeldungeon.ui.BossHealthBar;
import com.fixakathefix.towerpixeldungeon.ui.CharHealthIndicator;
import com.fixakathefix.towerpixeldungeon.ui.GameLog;
import com.fixakathefix.towerpixeldungeon.ui.Icons;
import com.fixakathefix.towerpixeldungeon.ui.InventoryPane;
import com.fixakathefix.towerpixeldungeon.ui.LootIndicator;
import com.fixakathefix.towerpixeldungeon.ui.MenuPane;
import com.fixakathefix.towerpixeldungeon.ui.QuickSlotButton;
import com.fixakathefix.towerpixeldungeon.ui.ResumeIndicator;
import com.fixakathefix.towerpixeldungeon.ui.RightClickMenu;
import com.fixakathefix.towerpixeldungeon.ui.StatusPane;
import com.fixakathefix.towerpixeldungeon.ui.StyledButton;
import com.fixakathefix.towerpixeldungeon.ui.Tag;
import com.fixakathefix.towerpixeldungeon.ui.TargetHealthIndicator;
import com.fixakathefix.towerpixeldungeon.ui.Toast;
...
import com.fixakathefix.towerpixeldungeon.windows.WndGame;
import com.fixakathefix.towerpixeldungeon.windows.WndHero;
import com.fixakathefix.towerpixeldungeon.windows.WndInfoCell;
import com.fixakathefix.towerpixeldungeon.windows.WndInfoItem;
import com.fixakathefix.towerpixeldungeon.windows.WndInfoMob;
import com.fixakathefix.towerpixeldungeon.windows.WndInfoPlant;
import com.fixakathefix.towerpixeldungeon.windows.WndInfoTrap;
...
import com.fixakathefix.towerpixeldungeon.windows.WndStory;
...
public class GameScene extends PixelScene {
	...
	//public static float TIME_PER_TURN = 3;
	...
	public void create() {
		...
		super.create();
		if (Dungeon.hero != null && Dungeon.hero.isAlive() && Dungeon.hero.buff(ScrollOfUnspeakableHorrors.Silentio.class)!=null) {
		...
		heroSp = new HeroSprite();
		heroSp.place( Dungeon.hero.pos );
		heroSp.updateArmor();
		if (hero.buff(Faint.class)!=null) heroSp.play(heroSp.die, true);
		mobs.add(heroSp);
		...
		switch (InterlevelScene.mode) {
			case RESURRECT:
				...
				new Flare( 5, 16 ).color( 0xFFFF00, true ).show(heroSp, 4f ) ;
				break;
			case RETURN:
				ScrollOfTeleportation.appearVFX( Dungeon.hero );
				break;
		...
		switch (InterlevelScene.mode){
			case FALL: case DESCEND: case CONTINUE:
				Camera.main.snapTo(heroSp.center().x, heroSp.center().y - DungeonTilemap.SIZE * (defaultZoom/Camera.main.zoom));
				break;
			case ASCEND:
				Camera.main.snapTo(heroSp.center().x, heroSp.center().y + DungeonTilemap.SIZE * (defaultZoom/Camera.main.zoom));
				break;
			default:
				Camera.main.snapTo(heroSp.center().x, heroSp.center().y);
		}
		Camera.main.panTo(heroSp.center(), 2.5f);
