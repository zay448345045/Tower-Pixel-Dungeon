...
package com.towerpixel.towerpixeldungeon.items.artifacts;
...
import com.towerpixel.towerpixeldungeon.actors.buffs.CounterBuff;
...
import com.towerpixel.towerpixeldungeon.effects.Surprise;
...
public class MasterThievesArmband extends Artifact {
	...
	public class Thievery extends ArtifactBuff {
		...
		public float stealChance(Item item){
			...
			return Math.min(0.9f, val/1.3f/item.value());
		}
