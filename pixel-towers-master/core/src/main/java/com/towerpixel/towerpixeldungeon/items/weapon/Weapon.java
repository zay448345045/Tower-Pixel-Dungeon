...
import com.towerpixel.towerpixeldungeon.items.weapon.enchantments.Blooming;
import com.towerpixel.towerpixeldungeon.items.weapon.enchantments.Chilling;
import com.towerpixel.towerpixeldungeon.items.weapon.enchantments.Corrupting;
import com.towerpixel.towerpixeldungeon.items.weapon.enchantments.Elastic;
import com.towerpixel.towerpixeldungeon.items.weapon.enchantments.Empowering;
...
import com.towerpixel.towerpixeldungeon.items.weapon.enchantments.Projecting;
...
abstract public class Weapon extends KindOfWeapon {
	...
	public String rarity() {
		String x = "raritymissing";
		if ((rarity<7) || (rarity>0)) switch (rarity){
			case 1: {x = Messages.get(this, "rarity1");break;}
			case 2: {x = Messages.get(this, "rarity2");break;}
			case 3: {x = Messages.get(this, "rarity3");break;}
			case 4: {x = Messages.get(this, "rarity4");break;}
			case 5: {x = Messages.get(this, "rarity5");break;}
			case 6: {x = Messages.get(this, "rarity6");break;}
		}
		return x;
	}
	...
	public String info() {
		...
		if (levelKnown) {
			info += "\n\n" + Messages.get(Weapon.class, "stats_known", tier, augment.damageFactor(min()), augment.damageFactor(max()), STRReq());
			if (STRReq() > hero.STR()) {
			...
			info += "\n\n" + Messages.get(Weapon.class, "stats_unknown", tier, min(0), max(0), STRReq(0));
	...
	public String desc() {
		return Messages.get(this, "desc");//FIXME set to addToString method for it to work faster
	}
