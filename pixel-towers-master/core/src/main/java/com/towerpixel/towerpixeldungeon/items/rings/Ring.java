...
import com.towerpixel.towerpixeldungeon.actors.buffs.EnhancedRings;
...
import com.towerpixel.towerpixeldungeon.items.KindofMisc;
	...
	private static final LinkedHashMap<String, Integer> gems = new LinkedHashMap<String, Integer>() {
		{
			...
			put("sunstone",ItemSpriteSheet.RING_SUNSTONE);
