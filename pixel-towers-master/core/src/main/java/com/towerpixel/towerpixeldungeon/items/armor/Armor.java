...
package com.towerpixel.towerpixeldungeon.items.armor;
...
import com.towerpixel.towerpixeldungeon.actors.buffs.Momentum;
...
import com.towerpixel.towerpixeldungeon.items.armor.curses.AntiEntropy;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Bulk;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Corrosion;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Displacement;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Metabolism;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Multiplicity;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Overgrowth;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Stench;
import com.towerpixel.towerpixeldungeon.items.armor.curses.Unreliable;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Affection;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.AntiMagic;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Brimstone;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Camouflage;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Entanglement;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Evasion;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Flow;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Holy;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Obfuscation;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Potential;
import com.towerpixel.towerpixeldungeon.items.armor.glyphs.Repulsion;
...
public class Armor extends EquipableItem {
	...
	public int DRMax(int lvl){
		...
		int max = tier * (1 + lvl) + augment.defenseFactor(lvl);
		if (lvl > max){
			return (lvl - max)/2;
		} else {
			return max;
