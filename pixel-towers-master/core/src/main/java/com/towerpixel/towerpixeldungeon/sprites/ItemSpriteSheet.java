...
public class ItemSpriteSheet {
	...
	public static final int FIST_ATTACK          = WEP_TIER1+1;
	...
	static{
		...
		assignItemRect(FIST_ATTACK,		16, 11);
	...
	public static final int DUAL_HATCHET    = WEP_TIER2+5;
	public static final int STONE_HAMMER    = WEP_TIER2+6;
	public static final int CURVED_KNIFE    = WEP_TIER2+7;
	public static final int RED_KNIFE       = WEP_TIER2+8;
	public static final int BLUE_KNIFE      = WEP_TIER2+9;
	static{
		...
		assignItemRect(DUAL_HATCHET,    14, 14);
		assignItemRect(STONE_HAMMER,    16, 16);
		assignItemRect(CURVED_KNIFE,    10, 11);
		assignItemRect(RED_KNIFE,       10, 10);
		assignItemRect(BLUE_KNIFE,      10, 10);
	}

	private static final int WEP_TIER3      =                               xy(1, 7);   //8 slots
	...
	public static final int TRISAI          = WEP_TIER3+6;
	public static final int BONE_MACHETE    = WEP_TIER3+7;
	public static final int GOLDEN_SWORD    = WEP_TIER3+8;
	static{
		...
		assignItemRect(TRISAI,          13, 13);
		assignItemRect(BONE_MACHETE,    15, 16);
		assignItemRect(GOLDEN_SWORD,    14, 14);
	}
	...
	public static final int ROYAL_DAGGER    = WEP_TIER4+6;
	public static final int BATONS          = WEP_TIER4+7;
	public static final int LONGBLADE       = WEP_TIER4+8;
	public static final int SCEPTER         = WEP_TIER4+9;
	public static final int DUAL_SPEARS     = WEP_TIER4+10;
	static{
		...
		assignItemRect(ROYAL_DAGGER,    13, 13);
		assignItemRect(BATONS,          13, 13);
		assignItemRect(LONGBLADE,       15, 16);
		assignItemRect(SCEPTER,         15, 15);
		assignItemRect(DUAL_SPEARS,     16, 16);
	}
	...
	public static final int DUAL_GLAIVE     = WEP_TIER5+6;
	public static final int BONE_CLAYMORE   = WEP_TIER5+7;
	static{
		...
		assignItemRect(DUAL_GLAIVE,  14, 16);
		assignItemRect(BONE_CLAYMORE,16, 16);
	}
	private static final int WEP_TIER6      =                               xy(17, 8);   //8 slots
	public static final int CIRCULAR_RAZORS    = WEP_TIER6+0;
	public static final int HEAVY_AXE          = WEP_TIER6+1;
	public static final int KUSARIGAMA         = WEP_TIER6+2;
	static{
		assignItemRect(CIRCULAR_RAZORS,  16, 16);
		assignItemRect(HEAVY_AXE,        16, 16);
		assignItemRect(KUSARIGAMA,       15, 15);
	}
	private static final int WEP_TIER7      =                               xy(1, 9);   //8 slots
	public static final int BONESTEEL_CLAYMORE  = WEP_TIER7+0;
	public static final int PAX                 = WEP_TIER7+1;
	public static final int CRYSTAL_BLADE       = WEP_TIER7+2;
	public static final int DRAGON_DUAL_BLADE   = WEP_TIER7+3;
	static{
		assignItemRect(BONESTEEL_CLAYMORE,16, 16);
		assignItemRect(PAX,               16, 16);
		assignItemRect(CRYSTAL_BLADE,     12, 14);
		assignItemRect(DRAGON_DUAL_BLADE, 14, 14);
	}
	private static final int WEP_TIER8      =                               xy(17, 9);   //8 slots
	public static final int BAN_HAMMER      = WEP_TIER8+0;
	public static final int INFIPIKE        = WEP_TIER8+1;
	public static final int NEO_SABER       = WEP_TIER8+2;
	public static final int ATOMIC_RIFLE    = WEP_TIER8+3;
	static{
		assignItemRect(BAN_HAMMER,    16, 16);
		assignItemRect(INFIPIKE,      16, 16);
		assignItemRect(NEO_SABER,     14, 16);
		assignItemRect(ATOMIC_RIFLE,  15, 10);
	}
	...
	public static final int WAND_SNAKES         = WANDS+13;

	public static final int WAND_DEBUG          = WANDS+14;
	public static final int STAFF_BEAST     = WANDS+15;
	static {
	...
	public static final int RING_SUNSTONE   = RINGS+12;
	public static final int RING_SPINEL     = RINGS+13;
	public static final int RING_LUMINITE   = RINGS+14;
	static {
	...
	public static final int ARTIFACT_MIRRORIDLE = ARTIFACTS+23;
	public static final int ARTIFACT_MIRRORREADY= ARTIFACTS+24;
	public static final int ARTIFACT_MIRRORBROKEN   = ARTIFACTS+25;
	static{
		...
		assignItemRect(ARTIFACT_MIRRORIDLE, 16, 16);
		assignItemRect(ARTIFACT_MIRRORREADY,16, 16);
		assignItemRect(ARTIFACT_MIRRORBROKEN,16, 16);
	}
	...
	public static final int READABLESCROLL_NORMAL = DOCUMENTS +7;
	public static final int READABLESCROLL_ETHER = DOCUMENTS +8;
	static{
		...
		assignItemRect(READABLESCROLL_NORMAL,  15, 14);
		assignItemRect(READABLESCROLL_ETHER,  15, 14);

	}
	private static final int TOWERSPAWNERS             =                           xy(1, 36);  //16 slots
	public static final int TOWERSPAWNER_CROSSBOW         = TOWERSPAWNERS+0;
	public static final int TOWERSPAWNER_WAND             = TOWERSPAWNERS+1;
