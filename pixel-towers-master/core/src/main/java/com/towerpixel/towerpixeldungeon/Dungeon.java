...
import com.towerpixel.towerpixeldungeon.actors.buffs.Light;
...
import com.towerpixel.towerpixeldungeon.levels.LastLevel;
...
import com.towerpixel.towerpixeldungeon.levels.rooms.secret.SecretRoom;
...
import com.towerpixel.towerpixeldungeon.utils.DungeonSeed;
...
public class Dungeon {
	...
	public static void observe(){
		int dist = Math.max(Dungeon.hero.viewDistance, 30);
	...
	public static void observe( int dist ) {
		...
		for (Char ch : Actor.chars()){
			if (ch instanceof WandOfWarding.Ward
			        ...
			        || ch instanceof  Arena.AmuletTower){
