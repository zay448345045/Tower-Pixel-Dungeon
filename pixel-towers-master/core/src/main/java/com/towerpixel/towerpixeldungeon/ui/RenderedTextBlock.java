...
public class RenderedTextBlock extends Component {
	...
	private int orangeHightlightColor = 0xFF8800;
		...
		for (String str : tokens){
			...
			// ® - purple
			 ...
			 if (str.equals("_")){
				...
				if (redhighlighting) word.hardlight(redHightlightColor);
				if (orangehighlighting) word.hardlight(orangeHightlightColor);
				if (greenhighlighting) word.hardlight(greenHightlightColor);
				if (lightbluehighlighting) word.hardlight(lightblueHightlightColor);
				if (bluehighlighting) word.hardlight(blueHightlightColor);
				if (purplehighlighting) word.hardlight(purpleHightlightColor);
